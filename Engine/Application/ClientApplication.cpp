...
namespace Crane {
  void ClientApplication::PlatformInitialize() {
    ...
    Scope<Graphics::IRenderer> renderer = MakeScope<Graphics::SDLGPURenderer::SDLGPURenderer>(m_Window->GetHandle());
    m_RenderSystem = MakeScope<Graphics::Systems::RenderSystem>(renderer);
  }
  ...
  void ClientApplication::Render() {
    ...
    m_RenderSystem->RenderImGui([this]() {
      OnImGui();
    });
